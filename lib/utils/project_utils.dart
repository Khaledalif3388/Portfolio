class ProjectUtils {
  ...
  static const List<String> description = [
    "A live e-commerce website by which anyone can order products from anywhere. build with html, css and javascript.",
    "Application of Food delivery, that anyone can order food from restaurants. build with css.",
  ...
  static const List<String> links = [
    "https://github.com/Khaledalif3388/gadgetsultra",
